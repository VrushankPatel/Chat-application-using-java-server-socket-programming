...
public class temp extends JFrame
{
    ...
    public temp()
    {
        JLabel title=new JLabel("Chatting Application 1");
        ...
        setResizable(false);
        setTitle("Chatting Program in Java temp");
        setLayout(null);
        ...
        send.addActionListener(new ActionListener()
            ...
            public void actionPerformed(ActionEvent e)
            {
                try
                {
                    msg=msg+"\n"+"Creating Socket at port 1111 on localhost";
                    console.setText(msg);
        ...
        try
        {
            ...
            while(y<10)
            {
                msg=msg+"\nCreating ServerSocket with reserving new port 1212";
                console.setText(msg);
                ServerSocket sssa=new ServerSocket(1212);
